...
These metrics are integrated as a new wrapper that can be used with any of the previous algorithms in QDax. Tests have been created specifically to demonstrate their use with the DCRL-ME algorithm.

## 🚀 Running Tests and Environments

To test the LZ and OI metrics implementation across different environments, run the following tests:

```bash
# Test with Ant environment
python tests/dcrlme_oil_test.py

# Test with Rastrigin environment
python tests/dcrlme_rastrigin_oil_test.py

# Test with Sphere environment
python tests/dcrlme_sphere_oil_test.py
```

The figures generated by the tests will be saved in a folder called oil_figures.


## 📊 Visual Results

### High Synergy
![High Synergy Results](/docs/oil/Synergy.gif)

### High Redundancy
![High Redundancy Results](/docs/oil/Redundancy.gif)

### Different types of behavior

**Negative O-Information (Synergy)**

![742](/docs/oil/742.gif)
![840](/docs/oil/840.gif)
![143](/docs/oil/143.gif)

**Positive O-Information (Redundancy)**

![695](/docs/oil/695.gif)
![20](/docs/oil/20.gif)
![1014](/docs/oil/1014.gif)

**Low fitness (bad behaviors)**

![399](/docs/oil/399.gif)
![220](/docs/oil/220.gif)
