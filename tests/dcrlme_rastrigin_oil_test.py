...
def run_dcrlme_rastrigin_oil_test(num_iterations: int = 10) -> None:
...
def test_dcrlme_rastrigin_oil(num_iterations: int) -> None:
    """Test function for pytest."""
    repertoire = run_dcrlme_rastrigin_oil_test(num_iterations=100)
